...
<body>
	...
	<!-- Includes title bar which has search bar and event-mate header -->
	<jsp:include page="Searchbar.jsp" />

	<div class="divMain2" style="min-height: 100%;">
		
		<!--  Include header for div (Where the icons like home are) -->
		<jsp:include page="Header.jsp" />
			...
			%>
				<center>
					<p class="blueFont" style="margin-top:30%;">No event found</p>
				</center>
			<% 
			}
			else
				...
				%>
					...
					<div class="randomEvent">
						<div class="eventPicture">
							<center>
								<img src="${pageContent.request.contextPath}/EventMate/images/crowd.jpg" class=imgBorder width="636px" height="322px">
							</center>		
						</div>
					
					   <center>
						<br> <br> <span class="blueFontWithoutMarg" ><%=ts.getEvent() %> - </span>
						 <span	class="blueFont2"><%=ts.getDatess() %></span> 
						 <br> <br>
					     <span class="blackFont" ><%=ts.getDescription() %></span>
						 <br> <span class="blueFont2">Attending:</span> <span class="blackFont"><%= ts.getAttendee() %></span> 
						 <br>
						 <span class="blueFont2" >Venue: </span> <span class="blackFont"><%= ts.getVenue() %></span> 
						 <br>
						 <span class="blueFont2" >Location: </span> <span class="blackFont"><%= ts.getLocation() %></span>
						 <br> 
						 <span class="blueFont2" >Event Requirements: </span> <span class="blackFont"><%=ts.getEventReq() %></span> 
						 <br>
						<span class="blueFont2" >Event Type: </span> <span class="blackFont"><%=ts.getCategory() %></span> 
						<br><br><br>
						...
						{%>
							 <div style="width:50%;float:right;" > 
								<form action="${pageContent.request.contextPath}/EventMate/NotAttending2" method="post"> 
									<button type="submit" value="<%=ts.getEvent() %>" name="cross" style="float:left;border: none;background: none;"><img src="${pageContent.request.contextPath}/EventMate/images/cross2.png" width="100px" height="100px"></button>
								</form> 
							</div>
							<div style="width:50%;float:left;">
								<form action="${pageContent.request.contextPath}/EventMate/Attending2" method="post"> 
									<button type="submit" value="<%=ts.getEvent() %>" name="tick" style="float:right;border: none;background: none;"><img src="${pageContent.request.contextPath}/EventMate/images/tick2.png" width="100px" height="100px"></button>
								</form>
							</div>
							<%
							}
