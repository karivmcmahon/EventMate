...
<body>
	...
	<div class="divMain2" style="min-height: 100%;">
		...
		<br> <br> <br> 
		<span class="blueFont" style="margin-left:40%;">Edit your profile</span> 
		<br>
		<br>
		...
		<div class="styleform">
			...
			<form action = "${pageContent.request.contextPath}/EventMate/Settings" method = "post">
				...
				<br><br> 
				<span class="font">Edit Email: </span> <input type="text" name="email" value="${user.getEmail()}">
				<br><br>
				<span class="font">Edit Bio: </span> <textarea ROWS=2 COLS=20 name="editBio">${user.getBio()}</textarea><br>
				<br> 
				
				<span class="font">Edit Gender Preference: </span> 
				<select
					name="editGenderPref">
				...
				<br> <span class="font">Edit Age Preference:
				 <select
					name="minAge">
				...
				<br><br> <span class="font">Edit Distance Preference:
